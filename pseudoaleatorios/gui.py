...
class App:
    ...
    def show_main_menu(self):
        ...
        from .interfaces.conway_game import JuegoVidaConway
        def abrir_cuadrados():
        ...
        def abrir_vida():
            self.show_full_interface(lambda parent, back: JuegoVidaConway(parent, self.show_main_menu))
        botones = [
            ...
            ("Juego de la Vida de Conway", "#10b981", abrir_vida)
        ]
